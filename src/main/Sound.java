...
public class Sound {
	...
	public Sound() {
		...
		soundPath[20] = getClass().getResource("/Sound/chipwall.wav").toString();
		soundPath[21] = getClass().getResource("/Sound/dooropen.wav").toString();
		soundPath[22] = getClass().getResource("/Sound/FinalBattle.wav").toString();
	}
